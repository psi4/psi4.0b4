...
def _print_nbody_energy(energy_body_dict, header, embedding=False):
    ...
    for n in nbody_range:
        ...
        int_e_kcal = (energy_body_dict[n] -
                      energy_body_dict[1]) * constants.hartree2kcalmol if not embedding else np.nan
    ...
    for n in nbody_range:
        ...
        if n == 1:
            ...
            for i in cp_monomers_in_monomer_basis:
                ...
                cp_monomer_energy_list.append(component_results['energies'][key])
